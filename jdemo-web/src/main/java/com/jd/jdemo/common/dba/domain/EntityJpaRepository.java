...
public class EntityJpaRepository implements EntityRepository {
    ...
    @Override
    public <T extends Entity> List<T> findInSet(Class<T> clazz, String propertyName, Set<Object> paramValues) {
        CriteriaQuery criteriaQuery = new CriteriaQuery(this, clazz);
    ...
    @Override
    public <T extends Entity> List<T> findNotInSet(Class<T> clazz, String propertyName, Set<Object> paramValues) {
        CriteriaQuery criteriaQuery = new CriteriaQuery(this, clazz);
