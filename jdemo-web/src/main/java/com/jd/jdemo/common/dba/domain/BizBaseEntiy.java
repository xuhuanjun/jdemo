 ...
 */
@MappedSuperclass
public abstract class BizBaseEntiy extends BaseEntity {
    protected final static Logger logger = LoggerFactory.getLogger(BizBaseEntiy.class);
   ...
   /* @Id
    ...
    private String creatorDepartmentName = "大数据应用中心";
