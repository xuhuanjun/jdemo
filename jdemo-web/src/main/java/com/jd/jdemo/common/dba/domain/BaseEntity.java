...
import com.jd.jdemo.common.dba.utils.BeanUtils;
...
/**
 * 提供实体类的增删改查操作 Created by chenhw on 2016/3/11.
 */
...
public abstract class BaseEntity implements Entity {
    ...
    public boolean equals(Object other) {
        ...
        Map thisPropValues = new BeanUtils(this).getPropValuesExclude(new Class[]{Transient.class});
        Map otherPropValues = new BeanUtils(other).getPropValuesExclude(new Class[]{Transient.class});
     ...
     * @return
     * @author wujt
     * 2016年9月12日 下午2:17:03
     */
    public static <T extends Entity> T findFirstByProperty(Class<T> clazz, String propName, Object value) {
     ...
     * @return 符合条件的实体列表
     */
    public static <T extends Entity> T findFirstByProperties(Class<T> clazz, Map<String, Object> propValues) {
        List<T> result = getRepository().findByProperties(clazz, NamedParameters.create(propValues));
        if (result != null && !result.isEmpty()) {
            return result.get(0);
        }
        return null;
     ...
     * @return
     * @author wujt
     * 2016年9月18日 下午5:25:02
     */
    public static <T extends Entity> List<T> findInSet(Class<T> clazz, String paramString, Set<Object> paramValues) {
        Assert.notNull(paramString, "Parameters cannot be null");
     ...
     * @return
     * @author wujt
     * 2016年9月18日 下午5:26:11
     */
    public static <T extends Entity> List<T> findNotInSet(Class<T> clazz, String paramString, Set<Object> paramValues) {
        Assert.notNull(paramString, "Parameters cannot be null");
        Assert.notNull(paramValues, "Parameters cannot be null");
